...
3. `nrt_eucl.py` implements a series of runs of the DBSCAN algorithm with a Euclidean distance metric by chunking up the overall time period. This is used to construct the post-view evaluation metrics.

4. `nrt_network.py` implements a series of runs of the DBSCAN algorithm with a network-based distance metric by chunking up the overall time period. This is used to construct the post-view evaluation metrics.
